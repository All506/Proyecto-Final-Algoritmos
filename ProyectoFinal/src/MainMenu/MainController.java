...
import SidePanel.SidePanelController;
...
public class MainController implements Initializable, ColorChangeCallback {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/SidePanel/sidepanel.fxml"));
    ...
    private void loadSplashScreen() {
        try {
            ...
            fadeOut.setOnFinished((e) -> {
                try {
                    AnchorPane parentContent = FXMLLoader.load(getClass().getResource(("/MainMenu/main.fxml")));
